 ...
 */
export interface ResultPresContextInput {}

/**
 * The ContextOutput interface describes all the outputs of the component
 */
export interface ResultPresContextOutput {}
 ...
 */
export interface ResultPresContext extends Context<ResultPresContextInput, ResultPresContextOutput> {}
