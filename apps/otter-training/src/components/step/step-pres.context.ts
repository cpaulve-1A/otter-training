 ...
 */
export interface StepPresContextInput {}

/**
 * The ContextOutput interface describes all the outputs of the component
 */
export interface StepPresContextOutput {}
 ...
 */
export interface StepPresContext extends Context<StepPresContextInput, StepPresContextOutput> {}
